...
public class BubbleSorter {
    ...
    public static void bubbleSort(List<Laptop> laptops, Comparator<Laptop> comparator) {
        long startAlgoTime;
        long endAlgoTime;
        long algoTime;
    ...
    private static void swap(List<Laptop> laptops, int leftIndex, int rightIndex) {
